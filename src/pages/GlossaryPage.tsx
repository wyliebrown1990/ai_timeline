...
export default function GlossaryPage() {
  ...
  const [activeTab, setActiveTab] = useState<GlossaryTab>(() => {
    ...
    return tabParam === 'figures' ? 'figures' : 'terms';
  });
  ...
  // Handle tab change (Sprint 47)
  const handleTabChange = (tab: GlossaryTab) => {
    setActiveTab(tab);
    // Update URL with tab parameter
    if (tab === 'figures') {
      setSearchParams({ tab: 'figures' });
    } else {
      setSearchParams({});
    }
  ...
  // Handle key figure selection (Sprint 47)
  const handleSelectFigure = (figure: KeyFigure) => {
    setSelectedFigure(figure);
  };

  // Handle closing figure modal (Sprint 47)
  ...
  return (
    <div className="container-main py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            {/* Select Mode Toggle (Sprint 22) - only show for terms tab */}
            {activeTab === 'terms' && (
              <button
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl">
          {activeTab === 'terms'
            ...
            : 'Notable researchers, executives, and pioneers in AI history.'}
        </p>

        {/* Tab Navigation (Sprint 47) */}
        <div className="mt-6 border-b border-gray-200 dark:border-gray-700">
          <nav className="flex gap-6" aria-label="Glossary tabs">
            <button
            ...
            >
              ...
              {activeTab === 'terms' && (
                <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-orange-500 dark:bg-orange-400" />
              )}
            </button>
            <button
      ...
      {activeTab === 'terms' ? (
        ...
        /* Key Figures Tab (Sprint 47) */
        <KeyFiguresList onSelectFigure={handleSelectFigure} />
      )}
