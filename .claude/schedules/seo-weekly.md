...
5. Pull this week's findings from `GET /api/admin/seo/insights` for all four buckets, up to 50 per bucket.
6. For each finding, classify it into `auto_ship`, `propose`, or `human_only` using the SEOAuditAgent skill rules.
