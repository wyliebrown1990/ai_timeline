...
// POST /api/admin/key-figures/process-all-drafts - Process all drafts with AI and publish
adminRouter.post('/process-all-drafts', requireAdmin, keyFiguresController.processAllDrafts);
